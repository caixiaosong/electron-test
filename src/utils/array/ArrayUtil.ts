...
export class ArrayUtil {
     ...
     */
    public static bitToArr(value: number, startIndex: number = 0, endIndex: number = BitUtil.MAX_BIT_FOR_NUM): Array<number> {
     ...
     */
    public static shuff<T>(arr: Array<T>, shuffTime: number = 20): Array<T> {
        for (var i: number = 0; i < shuffTime; ++i) {
     ...
     * @param endIndex
     */
    public static createNumArr(startIndex: number, endIndex: number): Array<number> {
     ...
     * @param shuffTime洗牌次数
     */
    public static createValueAndShuff(startIndex: number, endIndex: number, shuffTime: number = 20): Array<number> {
